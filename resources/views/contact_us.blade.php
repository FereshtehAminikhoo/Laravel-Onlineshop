...
@section('content')
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-md-9 m-auto">
                <div class="bg-white border contact_us">
                    <div class="row">
                        <div class="col-md-12 mt-4 header_contact_us">
                            <h4>تماس با آنلاین شاپ</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mt-4 text_contact_us">
                            <span>برای تماس با ما لطفا فرم زیر را تکمیل نمایید.</span>
                        </div>
                    </div>
                    <div class="border-bottom mt-3 mx-auto" style="width: 95%;"></div>
                    <div class="row">
                        <div class="col-md-12">
                            <form>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 mt-4 contact_us_form1">
                                        <label>موضوع</label>
                                        <select id="inputState" class="form-control">
                                            <option selected>موضوع را انتخاب کنید</option>
                                            <option value="1">پیشنهاد</option>
                                            <option value="2">انتقاد یا شکایات</option>
                                            <option value="3">پیگیری سفارش</option>
                                            <option value="1">خدمات پس از فروش</option>
                                            <option value="1">استعلام گارانتی</option>
                                            <option value="1">مدیریت</option>
                                            <option value="1">حسابداری و امور مالی</option>
                                            <option value="1">سایر موضوعات</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 col-sm-12 mt-4 contact_us_form2">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-4 textarea_contact_us">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-4 text-center upload_contact_us">
                            <div class="card">
                                <div class="card-body mr-3 ml-3 card_upload_contact_us">
                                    <p>تصویر یا ویدئو خود را آپلود کنید</p>
                                    <label for="imgvideo"><i class="material-icons icon_upload">cloud_upload</i>افزودن عکس یا ویدئو</label>
                                    <input type="file" id="imgvideo" onchange= "getImageVideo(this.value)">
                                    <div id="display-img-video"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mt-3 submit_contact_us">
                            <a href="{{route('contact_us')}}" class="btn btn_contact_us" onclick="event.preventDefault();showSending()">ثبت و ارسال</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        function getImageVideo(imageVideoName){
            var newImageVideo = imageVideoName.replace(/^.*\\/,"");
            $('#display-img-video').html(newImageVideo);
        }
    </script>
    <script>
